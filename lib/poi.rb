...
# Java
require 'java'
require File.join(JRUBY_POI_LIB_PATH, 'poi-3.9.jar')
require File.join(JRUBY_POI_LIB_PATH, 'poi-ooxml-3.9.jar')
require File.join(JRUBY_POI_LIB_PATH, 'poi-ooxml-schemas-3.9.jar')
require File.join(JRUBY_POI_LIB_PATH, 'poi-scratchpad-3.9.jar')
